...
// Footer section.
$page = new admin_settingpage("theme_eadflix_footer", get_string("footersettings", "theme_eadflix"));
...
$setting = new admin_setting_configtext("theme_eadflix/footer_background_color",
    get_string("footer_background_color", "theme_eadflix"),
    get_string("footer_background_color_desc", "theme_eadflix") . $htmlselect,
    "#1a2a6c");
...
$setting = new admin_setting_heading("theme_eadflix_footer_heading_description",
    get_string("footer_heading_description_title", "theme_eadflix"),
    get_string("footer_heading_description_desc", "theme_eadflix"));
$page->add($setting);
...
for ($i = 1; $i <= 4; $i++) {
    ...
    $setting = new admin_setting_configtext("theme_eadflix/footer_title_{$i}",
        get_string("footer_title", "theme_eadflix", $i),
        get_string("footer_title_desc", "theme_eadflix", $i), "");
    $page->add($setting);

    $setting = new admin_setting_confightmleditor("theme_eadflix/footer_html_{$i}",
        get_string("footer_html", "theme_eadflix", $i),
        get_string("footer_html_desc", "theme_eadflix", $i), "");
    $page->add($setting);
}

$setting = new admin_setting_heading('theme_eadflix_footerblock_copywriter',
    get_string('footer_copywriter', 'theme_eadflix'), '');
$page->add($setting);

$setting = new admin_setting_configcheckbox('theme_eadflix/footer_show_copywriter',
    get_string('footer_show_copywriter', 'theme_eadflix'),
    get_string('footer_show_copywriter_desc', 'theme_eadflix'), 1);
$page->add($setting);
